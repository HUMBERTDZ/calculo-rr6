...
/**
 * The persistent class for the CADQ database table.
 * 
 */
@Entity
@Table(name="CADQ")
...
public class Cadq implements Serializable {
	...
	@Column(name="CVE_CADQ")
	private String cveCadq;
	...
	public String getClaveCtoAdq() {
		return this.claveCtoAdq;
	}

	public void setClaveCtoAdq(String claveCtoAdq) {
		this.claveCtoAdq = claveCtoAdq;
	}

	public String getCveCadq() {
		return this.cveCadq;
	}

	public void setCveCadq(String cveCadq) {
		this.cveCadq = cveCadq;
	}
	...
	public String getSubClaveCtoAdq() {
		return this.subClaveCtoAdq;
	}

	public void setSubClaveCtoAdq(String subClaveCtoAdq) {
		this.subClaveCtoAdq = subClaveCtoAdq;
	}
