...
public class Irre implements Serializable {
	...
	private static final long serialVersionUID = -4395745900759014068L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "CVE_IRRE")
	private int cveIrre;
	...
	public int getCveIrre() {
		return cveIrre;
	}

	public void setCveIrre(int cveIrre) {
		this.cveIrre = cveIrre;
	}
