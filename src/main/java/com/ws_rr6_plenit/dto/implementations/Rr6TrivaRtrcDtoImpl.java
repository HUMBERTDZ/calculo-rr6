...
public class Rr6TrivaRtrcDtoImpl implements Irr6TrivaRtrcDto {
	...
	@Override
	public ResponseMessage getRr6TrivaById(int idArchivo, int trimestre, int anio) {

		getfechas(trimestre, anio);	    
		ResponseMessage respuesta = iHistoricoRyRService.getRr6TrivaByNumFile(idArchivo, fechaInicio, fechaFin);
